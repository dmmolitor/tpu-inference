...
TUNED_BLOCK_SIZES_RAW = {
    ...
    (7, 16, 14336, 4096, 'float8_e4m3fn', 'int4'): (16, 14336, 512),
    (7, 16, 1536, 4096, 'float8_e4m3fn', 'int4'): (16, 1536, 2048),
    (7, 16, 2048, 4096, 'float8_e4m3fn', 'int4'): (16, 2048, 4096),
    (7, 16, 28672, 4096, 'float8_e4m3fn', 'int4'): (16, 7168, 2048, 4),
    (7, 16, 3072, 4096, 'float8_e4m3fn', 'int4'): (16, 3072, 2048),
    (7, 16, 4096, 4096, 'float8_e4m3fn', 'int4'): (16, 4096, 2048),
    (7, 16, 6144, 4096, 'float8_e4m3fn', 'int4'): (16, 1536, 4096),
    (7, 16, 7168, 4096, 'float8_e4m3fn', 'int4'): (16, 7168, 1024),
    (7, 16, 8192, 1024, 'float8_e4m3fn', 'int4'): (16, 8192, 512),
    (7, 16, 8192, 2048, 'float8_e4m3fn', 'int4'): (16, 8192, 512),
    (7, 16, 8192, 4096, 'float8_e4m3fn', 'int4'): (16, 8192, 1024),
